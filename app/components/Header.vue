<template>
    <header class="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 z-10 dark:bg-slate-900 dark:border-slate-800">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-1">
            <div class="relative mr-2">
              ...
              <input type="text" placeholder="Busca o escribe un comando" class="pl-10 pr-4 py-2 bg-white border border-slate-300 w-80 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent dark:bg-slate-800 dark:border-slate-700 dark:text-white">
            </div>
            ...
            <div class="flex items-center justify-center gap-2">
              ...
              <div>
                ...
                <div class="text-xs text-slate-500 dark:text-slate-400">Cerrar sesión</div>
              </div>
            </div>
          </div>
        </div>
